...
const infoList = [
  {
    name: '연애 뭐 식은 죽 먹기죠, 연애 재능 만땅 <아나>',
  ...
  {
    name: '이건 어때? 난 어때? 독특한 매력을 가진 <모이라>',
  ...
  {
    name: '결혼은 언제쯤 할까 신혼여행은 어디로?, 이상적인 연애관의 소유자 <솔저>',
  ...
  {
    name: '기념일에 무슨 이벤트 할까, 이벤트 플래너 <트레이서>',
  ...
  {
    name: '어 오늘 머리 바꿨네 잘 어울린다, 센스가 뛰어난 <솜브라>',
  ...
  {
    name: '산은 산이요 연애는 연애로다, 느긋하고 온순한 <라인하르트>',
